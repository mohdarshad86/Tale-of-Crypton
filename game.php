<?php 
  ...
  require './fb-init.php';    $_SESSION['nothing'] = 'Game Is Ended';
...
?><?php
  ...
  $userr = mysqli_fetch_assoc(mysqli_query($conn, $userq));
    ...
    $q = "select *from questions where id = $user_level";
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 class="white-text">Let's Play</h1>
            <p class="flow-text white-text">"No man can win every battle, but no man should fall without a struggle."</p>
            <p class="flow-text right white-text">– Peter Parker</p>

          <?php if($user_level == 31):?>
          <div class="row">
                <div class="col s12 m8 offset-m2">
                  <div class="card">
                    <div class="card-content">
                        <span class="card-title">Lorem, ipsum dolor.</span>
                      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aspernatur cumque quos quaerat? Impedit, delectus error.</p>
                    </div>
                  </div>
                </div>
          </div>
            ...
            <div class="row">
                <div class="col s12 m8 offset-m2">
                  <div class="card">
                    ...
                    <div class="card-content">
                        <span class="card-title">Question <?php echo $result['id']; ?>:</span>
                      <p><?php echo $result['hint']; ?></p>

                      <div class="clearfix"></div>
                      <form action="gameVeri.php" method="post">
                        <div class="row">
